...
window.REAL_REVIEW_PACK = {
  ...
  "summary": [
    {
      "id": "summary-01",
      "title": "Các tầng của AI",
      "content": "AI là ô lớn nhất, bao gồm Machine Learning, Deep Learning, Generative AI và LLM. LLM là tầng nền của hầu hết trải nghiệm AI hiện nay.",
      "source_pages": [
        3
      ],
    ...
    },
    {
      ...
      "source_excerpt": "Model không nhìn từ nguyên vẹn. Nó cắt văn bản thành các mảnh nhỏ gọi là token. Mỗi lần trả lời, model chỉ nhìn được một lượng chữ có hạn — gọi là context. Context càng dài càng tốn tiền và càng chậm.",
      "confidence": 1.0,
      "status": "ready"
    },
    {
    ...
    },
    {
      ...
      "source_excerpt": "temperature — “núm vặn độ liều”. top_p — “chỉ xem top đầu bảng” (p = 0.9). Lưu ý quan trọng: hai núm này không làm model thông minh hơn — chỉ đổi cách chọn từ, không thêm tri thức.",
      "confidence": 1.0,
      "status": "ready"
    }
  ],
  ...
  "warnings": [
    ...
    {
      "code": "LOW_CONFIDENCE_SCORE",
      "message": "insight 'insight-cluster-07' chưa xác minh chắc chắn với slide (grounded=True, confidence=0.2), cần Lab Coach duyệt.",
      "item_ids": [
        "insight-cluster-07"
      ]
    }
